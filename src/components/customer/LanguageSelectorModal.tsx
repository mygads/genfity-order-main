...
export function LanguageSelectorModal({ isOpen, onClose }: LanguageSelectorModalProps) {
  ...
  return (
    <>
      ...
      <div
        ref={modalRef}
        className="fixed bottom-0 left-0 right-0 z-[201] bg-white rounded-t-2xl shadow-2xl transform transition-transform duration-300 ease-out max-w-[500px] mx-auto"
        role="dialog"
        aria-modal="true"
