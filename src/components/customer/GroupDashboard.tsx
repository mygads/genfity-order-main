    ...
    return (
        <>
            ...
            <div className={`fixed inset-x-0 bottom-0 z-[100] flex justify-center ${isClosing ? 'animate-slideDown' : 'animate-slideUp'}`}>
                <div className="w-full max-w-[500px] bg-white dark:bg-gray-900 rounded-t-2xl shadow-2xl max-h-[85vh] flex flex-col">
                    {/* Header - White style matching Table Number modal */}
                    <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                        <div className="flex items-center gap-2">
                            <h2 className="text-base font-semibold text-gray-900 dark:text-white" style={{ margin: 0, lineHeight: 'normal' }}>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl">
                                    <div className="flex justify-between items-center">
                                        <span className="text-gray-600 dark:text-gray-400 text-sm">{t("groupOrder.items") || "Total Items"}</span>
                                ...
                                <button
                                    ...
                                    className="w-full py-2.5 text-red-600 dark:text-red-400 text-sm font-medium bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg transition-colors"
                                >
                    ...
                    {isViewerHost && !isMe && !participant.isHost && (
                        <>
                            <button
                                ...
                                className="p-1.5 text-orange-500 hover:bg-orange-100 dark:hover:bg-orange-900/30 rounded transition-colors disabled:opacity-50"
                                title="Make Host"
                            >
                                ...
                                <div className="flex justify-between items-start">
                                    <div className="flex-1">
                                        <div className="flex items-start gap-1.5">
                                            ...
                                            <span className="text-gray-900 dark:text-white font-medium">{item.menuName}</span>
                                        </div>
                                        {/* Addons */}
...
function ConfirmModal({
    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-end justify-center">
            ...
            <div className="relative bg-white dark:bg-gray-900 rounded-t-2xl p-4 w-full max-w-[500px] shadow-xl animate-slideUp">
                ...
                <div className="flex gap-3">
                    <button
                        onClick={onCancel}
                        disabled={isProcessing}
                        className="flex-1 py-3 border border-gray-200 dark:border-gray-700 rounded-lg font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-50 transition-colors"
                    >
                        Cancel
                    </button>
                    <button
