...
export default function OutletInfoModal({ isOpen, onClose, merchant, merchantCode }: OutletInfoModalProps) {
    ...
    const shareUrl = typeof window !== 'undefined'
        ? merchantCode
            ? `${window.location.origin}${customerOrderUrl(merchantCode, { mode: 'dinein' })}`
    ...
    const handleShareX = () => {
        const text = tOr(t, 'customer.outletInfo.shareText', 'Check out {name}!', { name: merchant.name });
    ...
    const handleShareWhatsApp = () => {
        const text = `${tOr(t, 'customer.outletInfo.shareText', 'Check out {name}!', { name: merchant.name })} ${shareUrl}`;
    ...
    const handleShareEmail = () => {
        const subject = tOr(t, 'customer.outletInfo.shareEmailSubject', 'Check out {name}!', { name: merchant.name });
        const body = tOr(t, 'customer.outletInfo.shareEmailBody', 'I found this great place: {name}\n\n{url}', { name: merchant.name, url: shareUrl });
                    ...
                    <header className="relative shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
                        <div className="flex items-center px-4 py-3">
                            <div className="flex-1 text-center font-semibold text-gray-900">
                                {tOr(t, 'customer.outletInfo.title', 'Outlet info')}
                            </div>
                        </div>
                    </header>
                    {/* Content */}
                    <div className="max-h-[80vh] overflow-y-auto">
                            ...
                            {merchant.address && (
                                <div className="flex gap-2 mt-2">
                                    ...
                                    <button
                                        ...
                                        aria-label={tOr(t, 'customer.outletInfo.share', 'Share')}
                                    >
                            ...
                            {merchant.description && (
                                <div className="mt-4">
                                    <div className="text-xs font-semibold text-gray-700 mb-1">
                                        {tOr(t, 'customer.outletInfo.about', 'About')}
                                    </div>
                        ...
                        <div className="flex items-center gap-2 px-4 pb-2 border-b border-gray-200">
                            {merchant.phone && (
                                ...
                                >
                                    ...
                                    {tOr(t, 'customer.outletInfo.contactUs', 'Contact us')}
                                </a>
                            )}
                            ...
                            {(merchant.address || (merchant.latitude && merchant.longitude)) && (
                                ...
                                >
                                    ...
                                    {tOr(t, 'customer.outletInfo.visitUs', 'Visit us')}
                                </a>
                            )}
                        </div>
                        ...
                        <div className="px-4 py-6">
                            <h3 className="text-base font-semibold text-gray-900 mb-4">
                                {tOr(t, 'customer.outletInfo.operationalHours', 'Operational hours')}
                            </h3>
                                            ...
                                            <div key={hours.id.toString()}>
                                                <div className="flex items-center justify-between py-3">
                                                    <span className={`text-xs uppercase pl-3 ${isToday
                                                        ...
                                                        {t(dayKeyByIndex[hours.dayOfWeek] ?? 'customer.store.unknown')}
                                                    </span>
                                                    ...
                                                    <span className={`text-xs ${isToday
                                                        ...
                                                        {hours.isClosed
                                                            ? t('common.closed')
                                                            : hours.is24Hours
                                                                ? tOr(t, 'customer.outletInfo.open24Hours', 'Open 24 hours')
                        ...
                        <div className="w-full max-w-[400px] bg-white rounded-2xl shadow-2xl animate-scale-in">
                            ...
                            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
                                <h3 className="text-lg font-semibold text-gray-900">
                                    {tOr(t, 'customer.outletInfo.shareToFriend', 'Share to your friend')}
                                </h3>
                                <button
                                    onClick={() => setShowShareModal(false)}
                                ...
                                <div className="grid grid-cols-4 gap-4 mt-4">
                                    ...
                                    >
                                        ...
                                        <span className="text-xs text-gray-600">
                                            {copySuccess ? tOr(t, 'customer.outletInfo.copied', 'Copied!') : tOr(t, 'customer.outletInfo.copyLink', 'Copy link')}
                                        </span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="text-xs text-gray-600">
                                            {tOr(t, 'customer.outletInfo.email', 'Email')}
                                        </span>
                                    </button>
                                </div>
                            </div>
