                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <li><a href="https://wa.me/6285174314023?text=Halo%2C%20saya%20tertarik%20dengan%20program%20referral%20GENFITY" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition-colors">{t('landing.nav.referral')}</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-xs text-gray-500 dark:text-gray-400">
                            <li className="flex items-center gap-2">
                                ...
                                <a href="mailto:sales@genfity.com" className="hover:text-[#173C82] dark:hover:text-blue-400 transition-colors">sales@genfity.com</a>
                            </li>
                            <li className="flex items-center gap-2">
