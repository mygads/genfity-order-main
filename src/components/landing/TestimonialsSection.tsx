...
export default function TestimonialsSection() {
    ...
    return (
        <section className="py-12 bg-gray-50 dark:bg-gray-800/50 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="max-w-3xl mx-auto relative">
                    <div className="overflow-hidden bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 min-h-[200px] flex items-center">
                        <div
                            className="flex transition-transform duration-500 ease-out w-full"
                            style={{ transform: `translateX(-${activeIndex * 100}%)` }}
                        >
                            {testimonials.map((item) => (
                                <div key={item} className="w-full flex-shrink-0 p-6 sm:p-8 flex flex-col sm:flex-row items-center gap-6">
                                    <div className="flex-shrink-0 relative">
                                        <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-orange-100 dark:border-orange-900 shadow-md relative">
                                            {/* Placeholder until real images are generated */}
                                            ...
                                            {/* Real Image */}
                                            {/* <Image 
                                                src={`/images/testimonials/profile_${item}.png`} 
                                                alt="User" 
                                                fill 
