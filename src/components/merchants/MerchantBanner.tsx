  ...
  const getStatusConfig = () => {
    if (!merchant.isActive) {
      return {
        ...
        text: t("admin.merchant.statusInactive"),
      };
    }
    ...
    if (merchant.isOpen) {
      return {
        ...
        text: merchant.isManualOverride
          ? `${t("admin.merchant.storeOpen")} (${t("admin.merchant.manual")})`
    ...
    return {
      ...
      text: merchant.isManualOverride
        ? `${t("admin.merchant.storeClosed")} (${t("admin.merchant.manual")})`
