        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            {currentOwner && activeTab === 'owner' && (
              <div className="rounded-lg bg-brand-50 border border-brand-200 p-3 dark:bg-brand-900/20 dark:border-brand-800">
                <div className="flex gap-2">
                  <svg className="h-5 w-5 shrink-0 mt-0.5 text-brand-600 dark:text-brand-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
