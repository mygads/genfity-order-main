  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-end justify-center" style={{ zIndex: 300 }}>
        ...
        <div className="relative w-full max-w-[420px] bg-white dark:bg-gray-800 rounded-t-2xl shadow-2xl menu-in-cart-slide-up flex flex-col max-h-[80vh]">
        {/* Drag Handle */}
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <button
                    ...
                    className="shrink-0 h-8 px-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center gap-1.5"
                  >
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="w-8 h-8 rounded-full border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center"
