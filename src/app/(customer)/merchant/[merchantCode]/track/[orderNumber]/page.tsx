...
function OrderTrackPageContent() {
    ...
    const fallbackBackHref =
        backParam === 'history'
            ? customerHistoryUrl(merchantCode, { mode: modeParam || undefined })
            : customerMerchantHomeUrl(merchantCode);

    const { backHref } = useCustomerBackTarget({ fallback: fallbackBackHref });
