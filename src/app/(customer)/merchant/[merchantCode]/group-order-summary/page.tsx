...
import { customerTrackUrl, customerMerchantHomeUrl } from '@/lib/utils/customerRoutes';
 ...
 */
function GroupOrderSummaryPageContent({
    params,
}: {
...
function GroupOrderSummaryFallback() {
    return (
...
export default function GroupOrderSummaryPage({
    ...
    return (
        <Suspense fallback={<GroupOrderSummaryFallback />}>
            <GroupOrderSummaryPageContent params={params} />
        </Suspense>
    );
}
