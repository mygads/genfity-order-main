...
import { customerMerchantHomeUrl, customerOrderUrl, customerPaymentUrl } from '@/lib/utils/customerRoutes';
...
function ViewOrderPageContent() {
  ...
  const handleProceedToPayment = () => {
    ...
    router.push(
      customerPaymentUrl(merchantCode, {
        mode,
        ...(isReservationFlow ? { flow: 'reservation' } : {}),
        ...(isScheduledFlow ? { scheduled: 1 } : {}),
        ...(isGroupOrderCheckout ? { groupOrder: true } : {}),
      })
    );
  };
        ...
        <div className="mx-3 mt-3 p-3 rounded-lg bg-red-50 border border-red-200">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <button
                onClick={() => router.push(customerMerchantHomeUrl(merchantCode))}
