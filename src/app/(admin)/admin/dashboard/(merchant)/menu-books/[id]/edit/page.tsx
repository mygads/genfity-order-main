...
export default function EditMenuBookPage() {
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            if (bookData.success) {
                ...
                setError(locale === 'id' ? 'Menu book tidak ditemukan' : 'Menu book not found');
            }
            ...
            setError(locale === 'id' ? 'Gagal memuat data' : 'Failed to fetch data');
        } finally {
            setLoading(false);
        }
    }, [bookId, router]);
    ...
    if (loading) {
        return (
            <div>
                <PageBreadcrumb pageTitle={t("admin.menuBooks.edit")} />
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950" data-tutorial="menu-book-edit-form">
                <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="text-right">
                        <div className="text-sm font-semibold text-gray-900 dark:text-white">{t("admin.menuBooks.edit")}</div>
