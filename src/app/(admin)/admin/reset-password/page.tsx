  ...
  if (!token) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
        <InvalidLinkCard
          title={t('admin.resetPassword.invalidTokenTitle')}
          message={t('admin.resetPassword.invalidTokenMessage')}
          actionHref="/admin/forgot-password"
          actionLabel={t('admin.resetPassword.requestNewLink')}
        />
      </div>
    );
  }
