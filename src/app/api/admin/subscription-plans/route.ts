...
const updatePlanSchema = z.object({
    ...
    completedOrderEmailFeeIdr: z.number().min(0).optional(),
    ...
    completedOrderEmailFeeAud: z.number().min(0).optional(),
    ...
    try {
        ...
        return NextResponse.json({
            ...
            data: plans.map((plan: any) => ({
                ...
                completedOrderEmailFeeIdr: Number((plan as any).completedOrderEmailFeeIdr ?? 0),
                ...
                completedOrderEmailFeeAud: Number((plan as any).completedOrderEmailFeeAud ?? 0),
