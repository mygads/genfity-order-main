 ...
 *
 * Validates a voucher code for a guest checkout preview and returns
 * computed discount metadata for the provided cart items.
 *
 * Note: This endpoint does NOT have an authenticated customer context.
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Validate public voucher error:', error);
