...
export const CONTEXTUAL_HINTS = {
  ...
  ordersQueueFirstVisit: {
    ...
    title: 'Kitchen Display Mode',
    message: 'This is your kitchen view! Orders automatically appear here. Drag to update status or click for details.',
    position: 'top-right' as const,
    type: 'info' as const,
    relatedTutorial: 'active-orders' as TutorialId,
    showOnce: true,
  ...
  ordersQueueSoundAlert: {
    ...
    message: 'Enable sound alerts to hear when new orders arrive. Never miss an order!',
    position: 'bottom-right' as const,
    type: 'tip' as const,
    showOnce: true,
    trigger: 'first-visit' as const,
